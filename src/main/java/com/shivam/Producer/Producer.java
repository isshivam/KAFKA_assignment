package com.shivam.Producer;

import com.shivam.Student_Data.UserModel;
...
public class Producer {
    public static void main(String[] args){
        ...
        properties.put("value.serializer", "com.shivam.Serialization.UserSerializer");

        KafkaProducer<String, UserModel> kafkaProducer = new KafkaProducer<>(properties);
        try{
            Random ob = new Random();
            for(int i = 1; i <= 20; i++){
                UserModel user= new UserModel(i,"shivam rai",ob.nextInt(80), "B.Tech");
